...
const bgUrl = 'https://cdn.builder.io/api/v1/image/assets%2Fc21b63e7074b4525a6e3164505c4a230%2Ffcc6827670244419818678eb20abc5a5?format=webp&width=1600';
  ...
  return (
    <main className="hero-section" aria-label="Ammachi AI landing">
      ...
      <div className="hero-content">
        ...
        <h1 className="hero-title">Welcome to <span className="accent">Ammachi AI</span></h1>
        <p className="hero-subtitle">Your Farming Assistant</p>
        <p className="hero-description">Smart, simple, and supportive tools for every farmer.</p>
        ...
        <footer className="hero-footer">© 2025 Ammachi AI. Built for the heart of farming.</footer>
      </div>
